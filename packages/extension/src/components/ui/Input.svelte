<script lang="ts">
  ...
  const baseClasses =
    'block w-full rounded-lg border bg-white/50 dark:bg-gray-800/50 px-3 py-2 text-sm transition-smooth text-gray-900 dark:text-gray-100 disabled:bg-gray-100/50 disabled:cursor-not-allowed disabled:text-gray-500 dark:disabled:text-gray-400';
